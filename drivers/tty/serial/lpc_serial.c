...
#define DRIVER_NAME   "w83627_serial"
...
static int lpc_startup (struct uart_port *port) {
	...
	lpc_port->serial_out (port, UART_IER, lpc_port->uart_reg[UART_LSR]);
...
static struct serial_data w83627dhg_A_16550a = { LPC_UART_TYPE_W83627_A, 0};
static struct serial_data w83627dhg_B_16550a = { LPC_UART_TYPE_W83627_B, 0};
